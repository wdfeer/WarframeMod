...
using static WarframeMod.Common.StackableBuff;

namespace WarframeMod.Content.Items.Weapons;

internal class NagantakaPrime : ModItem
{
    public const int ALT_FIRE_DOWNTIME = 120;
    public const int CRITICAL_DAMAGE_PERCENT = 15;
    public const int BLEED_CHANCE_PERCENT = 40;

    public override LocalizedText Tooltip =>
        base.Tooltip.WithFormatArgs($"+{CRITICAL_DAMAGE_PERCENT}%", BLEED_CHANCE_PERCENT);
    ...
    public override void AddRecipes()
    {
        ...
        recipe.AddIngredient<Nagantaka>();
        ...
        int type, int damage, float knockback)
    {
        ...
        p.GetGlobalProjectile<BuffGlobalProjectile>().AddBuff(Bleeding, BLEED_CHANCE_PERCENT);
