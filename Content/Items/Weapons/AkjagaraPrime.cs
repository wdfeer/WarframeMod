...
public class AkjagaraPrime : ModItem
{
    ...
    public override LocalizedText Tooltip =>
        base.Tooltip.WithFormatArgs(BASE_BLEED_CHANCE, $"+{CRIT_DAMAGE_INCREASE}%");
    ...
    public override void SetDefaults()
    {
        ...
        Item.UseSound =
            new SoundStyle("WarframeMod/Content/Sounds/AkjagaraPrimeSound").ModifySoundStyle(pitchVariance: 0.1f);
    }

    public override void AddRecipes()
        => CreateRecipe().AddIngredient(ItemID.HallowedBar, 12).AddIngredient(ItemID.DungeonDesertKey)
