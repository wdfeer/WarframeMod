...
namespace WarframeMod.Content.EmoteBubbles;
...
public abstract class ModTownEmote : ModEmoteBubble
{
	...
	public override string Texture => "WarframeMod/Content/EmoteBubbles/NPCEmotes";
...
public class OrdisEmote : ModTownEmote
{
